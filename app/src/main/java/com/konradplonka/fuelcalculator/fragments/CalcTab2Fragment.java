...
public class CalcTab2Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        View view = inflater.inflate(R.layout.fragment_calc_tab2, container, false);
    ...
    private void calculate() {
        ...
        FuelConsumptionComputations fuelConsumptionComputations = new FuelConsumptionComputations(distance, pricePerLiter, amountOfFuel);
        fuelConsumptionTextView.setText(df.format(fuelConsumptionComputations.calculateAverageFuelConsumpion()) + "l/100 km");
    ...
    private void initializeViewElements(View view) {
        ...
        fuelConsumptionTextView = view.findViewById(R.id.fuel_consumption_result);
